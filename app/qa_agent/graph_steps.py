...
class QAGraph():
    ...
    def _assist_stage1_node(self,state: AutoconState):
        ...
        if not is_revision:
            ...
            query = f"""Generate a comprehensive list of test scenarios for a given development item using the functional requirements document (FRD) or technical design document (TDD) when the FRD is unavailable.Leverage the Celigo product knowledge base to gain a detailed understanding of any product feature.
                        ...
                        - Generate more than 20 test scenarios for each test category whenever possible.


                        # Steps

                        1. **Document Analysis**: Begin by analyzing the provided FRD or TDD. Identify functional or technical aspects that need to be tested.
                        ...
                        Output should be formatted as a JSON array containing objects with the following structure:
                        - `scenarioDescription`: A string describing the test scenario.
                        - `expectedResults`: A string detailing the expected results for the scenario.
                        ...
                        **Example Output:**
                        ...
                        {{
                            'test_list':
                                ...
                                [
                                    ...
                                    // More scenarios based on document details
                                ]
                        }}
                        ```
                        ...
                        - For technical tasks in engineering without an FRD, focus on the expected technical outcomes from the TDD.
    ...
    def _assist_stage2_node(self,state: AutoconState):
        ...
        query = """Check what impact the "ILM (Integration Lifecyce Management)" product feature of Celigo integrator.io has on this task, in order to identify regression scenarios, list all the regression test scenarios. Leverage Celigo product knowledge base to gain a detailed understanding of "ILM (Integration Lifecyce Management)" product feature. Follow the same output format.
        """
    ...
    def _qa_reflection_stage2_node(self,state: AutoconState):
        ...
        out_state = {"message_history":[question] ,"stage2_revisions":revisions,"is_finished_stage2":is_finished,"is_test_list_processed":is_test_list_processed}
        filtered_state = {k: v for k, v in out_state.items() if v is not None}
        return filtered_state
